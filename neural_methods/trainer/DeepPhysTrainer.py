...
class DeepPhysTrainer(BaseTrainer):
    ...
    def __init__(self, config, data_loader):
        ...
        self.best_epoch = 0
        # Initialize unified CSV logger (provides self._append_csv_row)
        self._init_csv_logger()

        # Helper for contiguous GPU selection starting at base DEVICE index
        ...
        if config.TOOLBOX_MODE == "train_and_test":
            ...
            # OneCycleLR scheduler details: adjusts LR across epochs & steps.
    ...
    def save_model(self, index):
        """Save epoch checkpoint under unified run directory."""
